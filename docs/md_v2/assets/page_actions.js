...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function ensureMarkdownCached() {
    ...
    try {
      ...
      console.warn(
        "Page Actions: Markdown not available for this page.",
        error,
      );
      cachedMarkdown = null;
  ...
  function createPageActionsUI() {
    ...
    if (!mainContent) {
      console.warn(
        "Page Actions: Could not find #terminal-mkdocs-main-content",
      );
      return null;
    }
  ...
  (async () => {
    ...
    document
      .getElementById("action-copy-markdown")
    ...
    document
      .getElementById("action-view-markdown")
    ...
    document
      .getElementById("action-open-chatgpt")
      .addEventListener("click", (e) => {
        e.preventDefault();
        e.stopPropagation();
        openChatGPT();
    ...
    dropdown
      .querySelectorAll(".page-action-link:not(#action-copy-markdown)")
      .forEach((link) => {
    ...
    dropdown.addEventListener("keydown", (e) => {
      ...
      const links = Array.from(
        dropdown.querySelectorAll(".page-action-link:not(.disabled)"),
      );
