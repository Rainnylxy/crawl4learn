...
Blockly.Blocks["c4a_reload"] = {
  init: function () {
    this.appendDummyInput().appendField("RELOAD");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(BlockColors.NAVIGATION);
...
Blockly.Blocks["c4a_if_exists_else"] = {
  init: function () {
    ...
    this.setColour(BlockColors.CONTROL);
    this.setTooltip(
      "If element exists, then do something, else do something else",
    );
  },
};
...
Blockly.Blocks["c4a_if_js"] = {
  init: function () {
    this.appendDummyInput()
      ...
      .appendField("`")
      .appendField(
        new Blockly.FieldTextInput("window.innerWidth < 768"),
        "CONDITION",
      )
      .appendField("`")
      .appendField("THEN");
...
Blockly.Blocks["c4a_repeat_while"] = {
  init: function () {
    this.appendDummyInput()
      ...
      .appendField("`")
      .appendField(
        new Blockly.FieldTextInput("document.querySelector('.load-more')"),
        "CONDITION",
      )
      .appendField("`");
    this.appendStatementInput("DO").setCheck(null);
...
Blockly.Blocks["c4a_comment"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("#")
      .appendField(
        new Blockly.FieldTextInput("Comment", null, {
          spellcheck: false,
...
Blockly.Blocks["c4a_proc_def"] = {
  init: function () {
    ...
    this.appendDummyInput().appendField("ENDPROC");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
