...
class PlaygroundApp {
  ...
  loadMoreProducts() {
    ...
    console.log(
      `📦 Loaded ${batch} more products. Total: ${this.productsLoaded}`,
    );
  }
  ...
  handleMouseMove(e) {
    ...
    const adjustedX =
      x + rect.width > window.innerWidth ? x - rect.width - 30 : x;
    const adjustedY =
      y + rect.height > window.innerHeight ? y - rect.height - 30 : y;
